...
@mcp.tool()
def chat_with_watsonx(query: str, max_tokens: int = 200, temperature: float = 0.7) -> str:
    """
...
@mcp.tool()
def analyze_medical_symptoms(symptoms: str, patient_age: Optional[int] = None, 
                           patient_gender: Optional[str] = None) -> str:
    """
    ...
    try:
        ...
        params = {
            ...
            GenParams.TEMPERATURE: 0.3,  # Lower temperature for more consistent medical advice
        }
...
def get_patient_greeting(name: str) -> str:
    ...
    """
    return f"Hello {name}, I'm your AI medical assistant powered by IBM watsonx. How can I help you today? Please remember that I provide general information and cannot replace professional medical advice."
...
# Prompts
@mcp.prompt()
def medical_consultation_prompt(symptoms: str, duration: str = "", severity: str = "") -> str:
    """
